...
@Component({
    selector: 'jhi-role-ng',
    templateUrl: './role-ng.component.html'
})
export class RoleNgComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/role-ng'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: RoleNg) {
        return item.id;
    }
