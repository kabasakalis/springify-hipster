...
@Component({
    selector: 'jhi-genre-ng',
    templateUrl: './genre-ng.component.html'
})
export class GenreNgComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/genre-ng'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: GenreNg) {
        return item.id;
    }
