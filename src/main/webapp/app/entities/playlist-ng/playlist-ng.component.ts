...
@Component({
    selector: 'jhi-playlist-ng',
    templateUrl: './playlist-ng.component.html'
})
export class PlaylistNgComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: PlaylistNg) {
        return item.id;
    }
    registerChangeInPlaylists() {
        this.eventSubscriber = this.eventManager.subscribe('playlistListModification', (response) => this.reset());
    }
